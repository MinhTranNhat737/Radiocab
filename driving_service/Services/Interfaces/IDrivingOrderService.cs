...
namespace driving_service.Services.Interfaces
{
    public interface IDrivingOrderService
    {
        ...
        Task<DrivingOrderDto?> AssignDriverAsync(long orderId, long driverId, long vehicleId, long? driverScheduleId = null);
